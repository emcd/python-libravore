...
def _import_version( ):
    ...
    module = import_module( 'libravore' )
...
linkcheck_ignore = [
    ...
    r'https://emcd\.github\.io/python-libravore/.*',
    ...
    r'https://github\.com/emcd/python-libravore',
    r'https://github\.com/emcd/python-libravore/.*',
    # Package does not exist during initial development.
    r'https://pypi.org/project/libravore/',
